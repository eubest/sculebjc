    ...
    <>
      {isProcessing ? (
        ...
        <button
          ...
          disabled={isDisabled}
          type="submit"
          className="w-full mt-6 bg-yellow-600 border border-transparent rounded-md shadow-sm py-2 px-4 text-base font-medium text-white hover:bg-yellow-700 flex items-center justify-center"
        >
          {children}
        </button>
      )}
